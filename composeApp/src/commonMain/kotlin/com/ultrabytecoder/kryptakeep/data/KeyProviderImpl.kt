 ...
 * (SQLCipher-encrypted) database, handed to the signing block, and zeroed immediately
 * after — it lives in memory only for the milliseconds a transaction is signed.
 */
